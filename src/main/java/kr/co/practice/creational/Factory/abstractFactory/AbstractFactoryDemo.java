package kr.co.practice.creational.Factory.abstractFactory;
...
class HotDrinkMachine
{
    ...
    public HotDrinkMachine() throws Exception
    {
        ...
        for (AvailableDrink drink : AvailableDrink.values())
        {
            ...
            Class<?> factory = Class.forName("kr.co.practice.solid.Factory.abstractFactory." + factoryName + "Factory");
        ...
        Set<Class<? extends IHotDrinkFactory>> types =
                new Reflections("kr.co.practice.solid.Factory.abstractFactory") // ""
